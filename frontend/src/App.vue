  ...
  <div class="min-h-screen p-4 flex flex-col gap-4 max-w-6xl mx-auto">
    ...
    >
      ...
      <div class="bg-gray-900 rounded-xl p-4">
        ...
        <div class="text-4xl tracking-wider text-purple-300 h-16">
          {{ store.brailleUnicode }}
        </div>
        <div class="flex flex-wrap gap-2 mt-3">
          <BrailleCell
            v-for="(dots, i) in store.brailleOutput"
            :key="i"
            :dots="dots"
            :size="40"
          />
    ...
    >
      <div class="bg-gray-900 rounded-xl p-4 flex flex-col items-center gap-4">
        ...
        >
          <div class="text-7xl font-bold text-purple-400">
            {{ store.quizChar }}
          </div>
      ...
      <div class="bg-gray-900 rounded-xl p-4">
        ...
        <div class="grid grid-cols-3 gap-2 text-center mb-3">
          ...
          <div class="bg-gray-800 rounded p-2">
            <div class="text-2xl font-bold text-red-400">
              {{ store.score.total - store.score.correct }}
            </div>
            <div class="text-xs text-gray-400">
              错误
            </div>
        ...
        <div class="space-y-1 max-h-48 overflow-y-auto">
          <div
            v-for="(h, i) in store.history.slice(0, 20)"
            :key="i"
    ...
    <button
      class="bg-green-700 px-4 py-2 rounded self-start hover:bg-green-600 text-sm"
      @click="doExport"
    >
      导出翻译文本
    </button>
